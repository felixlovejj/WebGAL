#!/usr/bin/env python3
"""
Voice Design v3 — Adjust 4 voices per user feedback:
- 苏师姐: faster, younger, more powerful
- 李教授: less deep, faster, clearer
- 陈老师: completely new prompt — young, clean, powerful
- 王学长: more power and authority
"""
...
REGENERATE = [
    {
        "name": "苏师姐",
        "prompt": "一位21岁的女性研究生，声音清亮有力量，语速偏快有冲劲，干脆利落不拖沓。不是温柔型，而是自信果断、思维敏捷、有主见有魄力的年轻女性。标准普通话，声音要有年轻人的锐气和活力。",
        "preview_text": "别被卡脖子吓到。正因为他们不给，你才要自己造。这是危机和机遇并存的时代。",
    },
    {
        "name": "李教授",
        "prompt": "一位50岁的男性计算机教授，声音洪亮有力，中气十足，语速干脆不拖沓。不是低沉缓慢的老先生，而是精神饱满、说话利落有力量的技术领袖。标准普通话，声音要打得开，有共鸣但不闷。",
        "preview_text": "国外的方案，像别人给的鱼竿。看着好用，但鱼线多长、鱼钩多大——全捏在人家手里。华科要做的事，不是用别人的鱼竿，是造自己的渔船。",
    },
    {
        "name": "陈老师",
        "prompt": "一位28岁的青年男教师，声音干净清亮有穿透力，语速快有激情，干脆利落。像一位刚毕业不久、充满理想和热情的年轻教师，说话不拖泥带水，每个字都有力量。标准普通话，声音要有青年人的朝气和干劲，不闷不哑。",
        "preview_text": "新同学？快进来。今天的课在草棚里上，教学楼还没盖完。纸，和笔——这是我昨晚写的程序，47条指令，每一条都手写。",
    },
    {
        "name": "王学长",
        "prompt": "一位32岁的男性芯片工程师，声音沉稳有力，中气十足，每个字都掷地有声。不是平淡的技术人员，而是有底气有自信的技术骨干，说话有分量感和说服力。标准普通话，声音要有厚度和力量，让人信服。",
...
def main():
    ...
    for i, vd in enumerate(REGENERATE):
        ...
        if voice_id:
            ...
            if audio:
                audio_path = SAMPLE_DIR / f"{name}_trial_v3.mp3"
